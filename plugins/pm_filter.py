...
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, SINGLE_BUTTON, PROTECT_CONTENT, \
    SPELL_CHECK_REPLY, IMDB_TEMPLATE, SPELL_IMG, IMDB_DELET_TIME, NO_RESULTS_MSG, START_MESSAGE, PMFILTER, G_FILTER, BUTTON_LOCK, SUPPORT_CHAT_ID, BUTTON_LOCK_TEXT, NOR_IMG
...
async def next_page(bot, query):
    ...
    try:
        ...
        return await message.reply_text(f"ᴏʀʀʏ, Nᴏ ғɪʟᴇs ғᴏᴜɴᴅ ғᴏʀ ʏᴏᴜʀ ᴏ̨ᴜᴇʀʏ {movie}.", show_alert=True)
...
async def pm_spoll_choker(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("<b><u>🤔 𝖲𝗉𝖾𝗅𝗅𝗂𝗇𝗀 𝖬𝗂𝗌𝗍𝖺𝗄𝖾 𝖡𝗋𝗈 ❗</u>\n\n➥ നിങ്ങൾ ഉദ്ദേശിച്ച മൂവി താഴെ കാണുന്ന വല്ലതും ആണ് എങ്കിൽ.അതിൽ ക്ലിക്ക് ചെയ്യുക..!!\n\n➥ 𝖣𝗈𝗇'𝗍 𝖶𝗈𝗋𝗋𝗒 𝖢𝗁𝗈𝗈𝗌𝖾 𝖳𝗁𝖾 𝖢𝗈𝗋𝗋𝖾𝖼𝗍 𝖮𝗇𝖾 𝖡𝖾𝗅𝗈𝗐..!!</b>")
    ...
    btn.append([InlineKeyboardButton(text="⨳  C L Ф S Ξ  ⨳", callback_data=f'pmspolling#{user}#close_spellcheck')])
    k = await msg.reply_photo(photo=SPELL_IMG,caption="<b><u>🤔 𝖲𝗉𝖾𝗅𝗅𝗂𝗇𝗀 𝖬𝗂𝗌𝗍𝖺𝗄𝖾 𝖡𝗋𝗈 ❗</u>\n\n➥ നിങ്ങൾ ഉദ്ദേശിച്ച മൂവി താഴെ കാണുന്ന വല്ലതും ആണ് എങ്കിൽ.അതിൽ ക്ലിക്ക് ചെയ്യുക..!!\n\n➥ 𝖣𝗈𝗇'𝗍 𝖶𝗈𝗋𝗋𝗒 𝖢𝗁𝗈𝗈𝗌𝖾 𝖳𝗁𝖾 𝖢𝗈𝗋𝗋𝖾𝖼𝗍 𝖮𝗇𝖾 𝖡𝖾𝗅𝗈𝗐..!!</b>", reply_markup=InlineKeyboardMarkup(btn), reply_to_message_id=msg.id)
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        ...
        k = await msg.reply("<b><u>🤔 𝖲𝗉𝖾𝗅𝗅𝗂𝗇𝗀 𝖬𝗂𝗌𝗍𝖺𝗄𝖾 𝖡𝗋𝗈 ❗</u>\n\n➥ നിങ്ങൾ ഉദ്ദേശിച്ച മൂവി താഴെ കാണുന്ന വല്ലതും ആണ് എങ്കിൽ.അതിൽ ക്ലിക്ക് ചെയ്യുക..!!\n\n➥ 𝖣𝗈𝗇'𝗍 𝖶𝗈𝗋𝗋𝗒 𝖢𝗁𝗈𝗈𝗌𝖾 𝖳𝗁𝖾 𝖢𝗈𝗋𝗋𝖾𝖼𝗍 𝖮𝗇𝖾 𝖡𝖾𝗅𝗈𝗐..!!</b>", reply_markup = one_button)
        await asyncio.sleep(8)
        await k.delete()
        return
    ...
    btn.append([InlineKeyboardButton(text="⨳  C L Ф S Ξ  ⨳", callback_data=f'spolling#{user}#close_spellcheck')])
    k = await msg.reply_photo(photo=SPELL_IMG,caption="<b><u>🤔 𝖲𝗉𝖾𝗅𝗅𝗂𝗇𝗀 𝖬𝗂𝗌𝗍𝖺𝗄𝖾 𝖡𝗋𝗈 ❗</u>\n\n➥ നിങ്ങൾ ഉദ്ദേശിച്ച മൂവി താഴെ കാണുന്ന വല്ലതും ആണ് എങ്കിൽ.അതിൽ ക്ലിക്ക് ചെയ്യുക..!!\n\n➥ 𝖣𝗈𝗇'𝗍 𝖶𝗈𝗋𝗋𝗒 𝖢𝗁𝗈𝗈𝗌𝖾 𝖳𝗁𝖾 𝖢𝗈𝗋𝗋𝖾𝖼𝗍 𝖮𝗇𝖾 𝖡𝖾𝗅𝗈𝗐..!!</b>",
                    reply_markup=InlineKeyboardMarkup(btn))
